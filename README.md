...
binary "https://raw.githubusercontent.com/bear2b/specifications/master/ios/carthage/BearSDK.json" == 2.0.8
```
...
target `YourApp` do
    pod 'BearSDK', :podspec => 'https://raw.githubusercontent.com/bear2b/specifications/2.0.8/BearSDK.podspec'
end
```
...
* Download [zip archive](https://s3-eu-west-1.amazonaws.com/mobile-dev.bear2b.com/bearsdk-ios/2.0.8/BearSDK.framework.zip);
